...
namespace MorseCode.CsJs.UI.Controls.Grid
{
	public class GridBoundBooleanColumn<T> : GridBoundColumnBase<T, bool>, IGridBoundTextColumn<T, bool>
	{
		...
		public GridBoundBooleanColumn(string uniqueName, Expression<Func<T, IReadableObservableProperty<bool>>> propertyExpression)
		...
		public GridBoundBooleanColumn(string uniqueName, IPropertyExpression<T, IReadableObservableProperty<bool>> propertyExpression)
			: base(uniqueName, propertyExpression)
		{
		}
