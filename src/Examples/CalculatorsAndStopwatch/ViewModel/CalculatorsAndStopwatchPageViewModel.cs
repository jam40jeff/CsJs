...
namespace MorseCode.CsJs.Examples.CalculatorsAndStopwatch.ViewModel
{
    public class CalculatorsAndStopwatchPageViewModel
    {
        ...
        private readonly RemoteCalculatorViewModel _calculatorViewModel2 = new RemoteCalculatorViewModel();
        ...
        private readonly ObservableProperty<ICalculatorViewModel> _calculatorViewModel;
        ...
        public CalculatorsAndStopwatchPageViewModel(CalculatorsAndStopwatchApplicationViewModel applicationViewModel)
        {
            ...
            _calculatorViewModel = new ObservableProperty<ICalculatorViewModel>(_calculatorViewModel1);
        ...
        public ObservableProperty<ICalculatorViewModel> CalculatorViewModel
        {
        ...
        {
            CalculatorViewModel.Value = _isCalculator2.Value ? (ICalculatorViewModel) _calculatorViewModel1 : _calculatorViewModel2;
