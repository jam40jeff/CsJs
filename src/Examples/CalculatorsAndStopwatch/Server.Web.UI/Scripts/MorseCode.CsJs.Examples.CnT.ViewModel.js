(function() {
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.ApplicationErrorEventArgs
	var $MorseCode_CsJs_Examples_CnT_ViewModel_ApplicationErrorEventArgs = function(errorMessage, url, lineNumber) {
	...
	$MorseCode_CsJs_Examples_CnT_ViewModel_ApplicationErrorEventArgs.prototype = {
	...
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorsAndStopwatchApplicationViewModel
	var $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchApplicationViewModel = function() {
		this.$2$ApplicationErrorField = null;
		MorseCode.CsJs.ViewModel.ApplicationViewModelBase.call(this);
	};
	$MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchApplicationViewModel.prototype = {
		...
		onError: function(errorMessage, url, lineNumber) {
			this.onApplicationError(new $MorseCode_CsJs_Examples_CnT_ViewModel_ApplicationErrorEventArgs(errorMessage, url, lineNumber));
			return true;
		},
		get_defaultViewModel: function() {
			return new $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchViewModel();
		}
	};
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorsAndStopwatchViewModel
	var $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchViewModel = function() {
		this.$_calculatorViewModel1 = new $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel();
		this.$_calculatorViewModel2 = new $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel();
		this.$_stopwatchViewModel = new $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel();
		...
		this.$_calculatorViewModel = new (ss.makeGenericType(MorseCode.CsJs.Common.Observable.ObservableProperty$1, [$MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel]).$ctor1)(this.$_calculatorViewModel1);
	...
	$MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchViewModel.prototype = {
	...
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorViewModel
	var $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel = function() {
		...
		this.$_operand2 = null;
		this.$_result = null;
		this.$_operators = new (ss.makeGenericType(MorseCode.CsJs.Common.Observable.ObservableCollection$1, [$MorseCode_CsJs_Examples_CnT_ViewModel_Operator]).$ctor1)([0, 1, 2, 3]);
	...
	$MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel.prototype = {
	...
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.Operator
	var $MorseCode_CsJs_Examples_CnT_ViewModel_Operator = function() {
	};
	$MorseCode_CsJs_Examples_CnT_ViewModel_Operator.prototype = { Add: 0, Subtract: 1, Multiply: 2, Divide: 3 };
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.StopwatchViewModel
	var $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel = function() {
		...
		this.$_viewModes = new (ss.makeGenericType(MorseCode.CsJs.Common.Observable.ObservableCollection$1, [$MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel$ViewMode]).$ctor1)([0, 1]);
		...
		this.$_elapsedString = ss.makeGenericType(MorseCode.CsJs.Common.Observable.CalculatedProperty$1, [String]).create$1(ss.makeGenericType(MorseCode.CsJs.Common.Observable.ObservableProperty$1, [ss.TimeSpan]), ss.makeGenericType(MorseCode.CsJs.Common.Observable.ObservableProperty$1, [ss.Nullable])).call(null, this.$_elapsed, this.$_selectedViewMode, function(elapsed, selectedViewMode) {
			return $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel.$getTimeSpanString(elapsed.get_value(), selectedViewMode.get_value());
		}, null);
	...
	$MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel.prototype = {
	...
	$MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel.$getTimeSpanString = function(timeSpan, selectedViewMode) {
	...
	////////////////////////////////////////////////////////////////////////////////
	// MorseCode.CsJs.Examples.CnT.ViewModel.StopwatchViewModel.ViewMode
	var $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel$ViewMode = function() {
	};
	$MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel$ViewMode.prototype = { Milliseconds: 0, Seconds: 1 };
	ss.registerClass(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.ApplicationErrorEventArgs', $MorseCode_CsJs_Examples_CnT_ViewModel_ApplicationErrorEventArgs, ss.EventArgs);
	ss.registerClass(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorsAndStopwatchApplicationViewModel', $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchApplicationViewModel, MorseCode.CsJs.ViewModel.ApplicationViewModelBase);
	ss.registerClass(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorsAndStopwatchViewModel', $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorsAndStopwatchViewModel);
	ss.registerClass(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.CalculatorViewModel', $MorseCode_CsJs_Examples_CnT_ViewModel_CalculatorViewModel);
	ss.registerEnum(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.Operator', $MorseCode_CsJs_Examples_CnT_ViewModel_Operator);
	ss.registerClass(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.StopwatchViewModel', $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel);
	ss.registerEnum(global, 'MorseCode.CsJs.Examples.CnT.ViewModel.StopwatchViewModel$ViewMode', $MorseCode_CsJs_Examples_CnT_ViewModel_StopwatchViewModel$ViewMode);
})();
